            ...
            <div className="flex flex-col justify-center items-center space-y-6 mx-auto" style={{ maxWidth: '1200px' }}>
                ...
                <div className="flex flex-col items-center">
                    <div className="flex flex-col items-center mb-8">
                        <img src="/src/assets/icons/Projectmanager.png" alt="Project Manager" className="h-24 w-24 rounded-full" />
                        <p className="text-center text-white">Project Manager</p>
                    </div>
                    <div className="flex space-x-32 mb-8">
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Leadprogrammer.png" alt="Lead Programmer" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">Lead Programmer</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Leaduiux.png" alt="Lead UI/UX" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">Lead UI/UX</p>
                        </div>
                    </div>
                    <div className="flex space-x-32 mb-8">
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Backend.png" alt="Back-End" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">Back-End</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Frontend.png" alt="Front-End" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">Front-End</p>
                        </div>
                    </div>
                    <div className="flex space-x-28 mb-8">
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Helper.png" alt="Helper (Back-End)" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">Helper (Back-End)</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Helper2.png" alt="Helper (Front-End)" className="h-24 w-24 rounded-full" />
                    ...
                    <div className="flex space-x-16 mb-8">
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Ui.png" alt="UI" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">UI</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Ui2.png" alt="UI 2" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">UI</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Ux.png" alt="UX" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">UX</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Tester.png" alt="Tester" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">Tester</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <img src="/src/assets/icons/Tester2.png" alt="Tester 2" className="h-24 w-24 rounded-full" />
                            <p className="text-center text-white">Tester</p>
                        </div>
                    </div>
                </div>
