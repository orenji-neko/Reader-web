...
INSERT INTO "new_Book" ("authorId", "categoryId", "cover", "createdAt", "id", "rating", "status", "title", "updatedAt") SELECT "authorId", "categoryId", "cover", "createdAt", "id", "rating", "status", "title", "updatedAt" FROM "Book";
DROP TABLE "Book";
